...
const toolHandler = async ({ params }) => {
    ...
    return { content: [{ type: "text", text: `Attachable deleted successfully` }] };
};
export const DeleteAttachableTool = { name: toolName, description: toolDescription, schema: toolSchema, handler: toolHandler };
