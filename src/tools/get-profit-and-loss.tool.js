...
const toolHandler = async ({ params }) => {
    ...
    return { content: [{ type: "text", text: `Profit and Loss Report:` }, { type: "text", text: JSON.stringify(response.result, null, 2) }] };
};
export const GetProfitAndLossTool = { name: toolName, description: toolDescription, schema: toolSchema, handler: toolHandler };
