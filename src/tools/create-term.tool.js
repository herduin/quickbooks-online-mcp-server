...
const toolHandler = async ({ params }) => {
    ...
    return { content: [{ type: "text", text: `Term created:` }, { type: "text", text: JSON.stringify(response.result, null, 2) }] };
};
export const CreateTermTool = { name: toolName, description: toolDescription, schema: toolSchema, handler: toolHandler };
